class Credit extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.bitmapText(centerX, centerY+55, 'May_font', 'Musica- My Dream from Kamen Rider Revice', 30).setOrigin(.5)

        //how to go back
        this.add.bitmapText(centerX, centerY+95, 'May_font', 'Pulsa C para volver', 32).setOrigin(0.5)
